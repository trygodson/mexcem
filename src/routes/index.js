...
export const appPages = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Reward', path: '/manage/reward' },
      { label: 'Referral Program', path: '/manage/referral/program' },
      { label: 'Rating', path: '/manage/rating' },
      {
        label: 'Cancellation & Reasons',
        path: '/manage/cancellation/and/reasons',
      },
      { label: 'Feedback', path: '/manage/feedback' },
      { label: 'Issues & Reasons', path: '/manage/issues/and/reasons' },
      { label: 'Tool box', path: '/manage/toolbox' },
      { label: 'Environment', path: '/manage/environment' },
      { label: 'Promo code', path: '/manage/promo/code' },
      { label: 'Family plan', path: '/manage/family/plan' },
      { label: 'Payment', path: '/manage/payment' },
      { label: 'Pricing', path: '/manage/pricing' },
      { label: 'Report', path: '/manage/report' },
      { label: 'Pop up', path: '/manage/pop/up' },
    ],
    guarded: true,
