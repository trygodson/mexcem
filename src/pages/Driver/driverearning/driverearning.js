      ...
      <div className="mtop-2 tops ">
        <div className="row w100 jcb alc">
          <div classname="col-lg-4 smnjn">
            ...
            <div className="grey-container mtop-1  dflex flex-columm jcb">
              ...
              <div className="dflex jcb alc mtop-2 pricearea">
                <h4>$10.00</h4>
                <div className=" profile-submit-button cashout">cash out</div>
              </div>
          ...
          <div classname="col-lg-4">
            ...
            <div className="grey-container mtop-1 dflex flex-columm jcb">
              <div className="dflex jcc desc">
                <span>Today</span>
              </div>
              <div className="dflex flex-columm jcb alc pricearea  mtop-2">
                <h4 className="mtop-2">$0.00</h4>
                <div className=" cashout">
                  you haven't given any assist today
                </div>
              </div>
              <div className="bottomarea w100">
                <div className="dflex jcb alc ">
                  <span>See all daily earning</span>
                  <ChevronRight size={18} />
                </div>
              </div>
            </div>
      ...
      <section>
        <Card className="paddingNone" style={customCardStyle}>
          <div className="card-padded-title multiple dflex jcb">
            <h3 className="hoverPointer">Earings Analytics</h3>
        ...
        <Card>
          <LineChartDrawDriver height={300} />
        </Card>
      </section>
      <section>
        <Card className="paddingNone" style={customCardStyle}>
