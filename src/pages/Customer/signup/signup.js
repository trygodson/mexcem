  ...
  return (
    <div className="row">
      ...
      <div className="col-6 login-right">
        <div className="bg-form" style={{ marginTop: '20% !important' }}>
          ...
          <div className="form-info">
            ...
            <p>By signing up, you are certifying that you are 16 years of age or older.</p>
            <p>For information on data privacy see our Privacy Policy</p>
          </div>
          <button>Next</button>
          <Height val={5} />
