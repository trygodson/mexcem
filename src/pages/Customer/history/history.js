  ...
  const historyDecorator = [
    {
      ...
      Cell: props => (
        <span>
          {props.plate_number} - {props.color}
        </span>
      ),
    },
    {
    ...
    },
    {
      label: 'Status',
      accessor: 'status',
      Cell: props => <div className='success_span_text' style={customStatus}>{props}</div>,
    },
    {
      label: 'Total',
      accessor: 'total',
  ...
  return (
    ...
    <main>
      ...
      <section>
        ...
        <NewTable decorator={historyDecorator} tableData={tabledata} isloading={loading} addcheckbox={true}/>
