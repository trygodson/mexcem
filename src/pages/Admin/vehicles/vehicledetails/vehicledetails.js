  ...
  return (
    ...
    <main>
      <PageTitle
        title={
          <span>
            Vehicles / Stephen Jackson <b>/ Mercedess Benz</b>
          </span>
        }
      >
        <>
          ...
          <div style={{ padding: '20px' }}>
            <div className="row">
              ...
              <div className="col-4">
                <div className="form-group">
                  <h4>Plate number</h4>
                  <Input type='text' placeholder='1223cx' style={{ width: '100%', borderColor: 'grey' }} />
                  {/* <select>
            ...
            <Height val={5} />
            <div style={{ fontWeight: '500' }}>List of documents</div>
            <Height val={10} />
