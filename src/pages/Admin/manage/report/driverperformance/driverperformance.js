...
import { driverperformanceservice } from '../../../../../shared/hooks/api/testService.js';
...
function DriverPerformance() {
  ...
  useEffect(async () => {
    const data = await driverperformanceservice();
  ...
  const decorator = [
    ...
    {
      label: 'Requested Assists',
      accessor: 'requested_assist',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
    ...
    {
      label: 'Accepted Assist',
      accessor: 'accepted_assist',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
      label: 'Rejected Assist',
      accessor: 'rejected_assist',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
      label: 'Total Hours Online',
      accessor: 'online_hours',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
      label: 'Assist Distance',
      accessor: 'assist_distance',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
      label: 'Accepted Ratio',
      accessor: 'accepted_ratio',
      Cell: props => <span className="text-center">{props}</span>,
    },
    {
      label: 'Cancellation Ratio',
      accessor: 'cancelled_ratio',
      Cell: props => (
